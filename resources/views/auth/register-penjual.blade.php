...
<head>
    ...
    <title>Daftar Penjual (UMKM) - LokaMarket</title>
        ...
        <div class="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div class="lg:col-span-7 bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-slate-100 border border-slate-100">
                ...
                <div class="bg-stone-100 p-1.5 rounded-full flex gap-1 mb-6">
                    <a href="/register" class="flex-1 py-2 text-center rounded-full text-xs md:text-sm font-semibold text-slate-600 hover:text-slate-900">
                        Pembeli
                    </a>
                    <a href="/register-penjual" class="flex-1 py-2 text-center rounded-full text-xs md:text-sm font-bold bg-[#E88C08] text-white shadow-sm">
                        Penjual (UMKM)
                    </a>
                </div>

                <form action="/register-penjual" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <!-- Field Toko -->
                    <div>
                        <label class="block text-xs font-bold text-slate-800 mb-1.5">Toko</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 text-sm"><i class="fa-solid fa-shop"></i></span>
                            <input type="text" name="store_name" value="{{ old('store_name') }}" placeholder="Nama Toko" required
                                class="w-full pl-10 pr-4 py-2.5 rounded-full border border-slate-300 text-xs md:text-sm focus:outline-none focus:border-orange-500">
                        </div>
                    </div>
                    ...
                    <!-- Field Alamat Toko -->
                    <div>
                        <label class="block text-xs font-bold text-slate-800 mb-1.5">Alamat Toko</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 text-sm"><i class="fa-solid fa-location-dot"></i></span>
                            <input type="text" name="store_address" value="{{ old('store_address') }}" placeholder="Alamat lengkap toko" required
                                class="w-full pl-10 pr-4 py-2.5 rounded-full border border-slate-300 text-xs md:text-sm focus:outline-none focus:border-orange-500">
                        </div>
                    </div>
