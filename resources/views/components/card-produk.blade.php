...
<a href="{{ route('cust.detailProduk', ['produk' => $produk->slug]) }}"
    ...
    <div class="p-4">
        ...
        <p class="nama-produk line-clamp-2 min-h-12 text-sm font-bold text-[#3B2115] transition group-hover:text-orange-600">
            {{ $produk->nama }}
        </p>

        <div class="flex items-center gap-1.5">

            <div class="flex items-center gap-0.5 text-[11px] text-yellow-400">
            ...
            <span class="text-xs font-semibold text-[#72594B]">
