            ...
            @foreach ($kategori as $k)
                ...
                <label class="cursor-pointer">
                    <input type="radio"
                            ...
                            class="peer sr-only">
                    <span
                        class="inline-flex min-h-9 items-center justify-center rounded-full border border-[#E9D7C9] bg-white px-3 py-2 text-xs font-semibold text-[#3B2115] shadow-sm transition duration-200 hover:border-[#FFB778] peer-checked:border-[#FF6B00] peer-checked:bg-[#FFF1E5] peer-checked:text-[#C1440E] peer-checked:shadow-md">
                        {{ $k->nama }}
                    </span>
                </label>
